<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="父企业id" prop="parentId">
        <el-input
          v-model="queryParams.parentId"
          placeholder="请输入父企业id"
          clearable
          size="small"
    ...
    <el-table v-loading="loading" :data="enterpriseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="父企业id" align="center" prop="parentId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="父企业id" prop="parentId">
          <el-input v-model="form.parentId" placeholder="请输入父企业id" />
        </el-form-item>
        <el-form-item label="企业名称" prop="name">
